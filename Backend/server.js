...
function generatePDF(content, res) {
    ...
    // 🔷 Header Design
    doc.rect(0, 0, doc.page.width, 50).fill('#34495E');
    doc.fillColor('white').fontSize(16).text('📘 Sahil Assignment Generator', 50, 15);
    ...
    // 🔻 Footer Design
    doc.rect(0, doc.page.height - 40, doc.page.width, 40).fill('#34495E');
    doc.fillColor('white')
       .fontSize(10)
       .text('Generated by SahilCodeLab', 50, doc.page.height - 30, { align: 'center' });
